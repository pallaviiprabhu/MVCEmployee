...
namespace MVCEmployee.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,EmployeeId,ContactNo,Age,Department,JoinDate,Salary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,EmployeeId,ContactNo,Age,Department,JoinDate,Salary")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
